  ...
  return (
    <div className="building-floorplan-scroll">
      <div className="building-floorplan-canvas" style={{ width: CANVAS.width, height: CANVAS.height }}>
        ...
        {/* 화장실 */}
        <div className="building-deco" style={{ top: 20, left: 320, width: 70, height: 70, background: "#e9eef4", color: "#2e4b60", fontSize: 14 }}>
          <img src="/bathroom.png" alt="화장실" style={{ width: "30px", height: "30px", marginBottom: "4px" }} />
          여자화장실
        </div>

        <div className="building-deco" style={{ top: 20, left: 530, width: 70, height: 70, background: "#e9eef4", color: "#2e4b60", fontSize: 14 }}>
          <img src="/bathroom.png" alt="화장실" style={{ width: "30px", height: "30px", marginBottom: "4px" }} />
          남자화장실
        </div>
